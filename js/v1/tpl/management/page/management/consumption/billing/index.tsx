    ...
    render() {
        ...
        const search: Array<TypeFormItem | ComponentFormItem> = [
            ...
            { itemProps: { label: '消费数据源', hasFeedback: false }, initialValue: '-1',
                typeComponentProps: { placeholder: '消费数据源' }, key: 'source', type: 'select', options: [{ label: '全部', value: '-1' }, { label: '短信', value: '1' }, { label: '运营商-数据源B', value: '2' }, { label: '淘宝-数据源D', value: '3' }, { label: '合同', value: '5' }] },
