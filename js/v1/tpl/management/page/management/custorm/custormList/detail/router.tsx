...
import livingBody from './livingBody';
@observer
export default class Product extends React.Component<{}, any> {
    ...
    render() {
        return (
            <Title>
                <Switch>
                    <Route path='/management/custorm/custormList/:user/identityInfo' component={identityInfo} />
                    <Route path='/management/custorm/custormList/:user/livingBody ' component={livingBody} />
                </Switch>
            </Title>
        );
    }
