...
class Product extends React.Component<any, any> {
    ...
    edit(data: any) {
        ...
        mutate<{}, any>({
            ...
            const {contract_type, name} = r.data;
    ...
    getName(id: string|number) {
        ...
        console.log(this.signatureInfo, id, name);
        return name;
    }
    submit() {
    ...
    render() {
        ...
        const formItem: BaseFormItem[] = [
            ...
            { key:  'contract_file_url', type: 'select', itemProps: { label:  '合同文件' }, component: this.uploadComponent() },
