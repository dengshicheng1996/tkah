...
export const QiNiuUpload = async (file: any, callBack?: { next?: (res: any) => void, onError?: (err: any) => void, complete?: (res: any, file: any) => void }) => {
    const json = {
    ...
    obser.subscribe({
        ...
        complete: (res: any) => {
            callBack.complete && callBack.complete('http://imgcdn.alphae.cn/' + res.key, file);
        },
    });
};
