...
require('./error_display.noextract.css');
...
var showJSError = {
    ...
    init: function (settings) {
        ...
        if (window.addEventListener) {
            ...
            if (process.env.NODE_ENV === 'development') {
                window.addEventListener('unhandledrejection', this._onerror, false);
            }
        } else {
    ...
    _append: function () {
        ...
        this.elem({
            ...
            props: {
                type: 'button',
                value: this.settings.copyText || lang.copy,
                onclick: function () {
                    that.copyText();
                },
            },
    ...
    _getTitle: function () {
        return this.settings.title || lang.title;
    },
    _show: function () {
...
if (!window.showJSErrorInitOnce) {
    showJSError.init({});
    window.showJSErrorInitOnce = true;
}
